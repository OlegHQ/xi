...
const specs: Readonly<Record<SuiteId, SuiteSpec>> = {
  ...
  e2e: {
    ...
    selectors: { interaction: ['tests/e2e/t038-session.test.ts', 'tests/e2e/t039-picker.test.ts', 'tests/e2e/t039-picker-pty.py', 'tests/e2e/t040-explorer.test.ts', 'tests/e2e/t040-explorer-pty.py', 'tests/e2e/t043-search-pty.py', 'tests/e2e/t044-replace-pty.py', 'tests/e2e/t049-problems-pty.py', 'tests/e2e/t050-outline-pty.py', 'tests/e2e/t051-completion-pty.py', 'tests/e2e/t052-workspace-pty.py', 'tests/e2e/t045-g3.test.ts', 'tests/e2e/t086-pointer-pty.py', 'tests/e2e/t094-controls.test.ts', 'tests/e2e/t094-controls-pty.py', 'tests/e2e/t094-splitter-pty.py', 'tests/e2e/t094-terminal-pty.py', 'tests/distribution/t064-cli.test.ts', 'tests/distribution/t064-package.test.ts', 'tests/distribution/t064-editor-pty.py', 'tests/distribution/t064-file-pty.py', 'tests/distribution/t064-compiled-pty.py', 'tests/distribution/t064-ex-pty.py', 'tests/distribution/t064-vim-pty.py'] },
  },
  bench: {
    fixtureRoot: 'bench',
    roots: ['bench'],
