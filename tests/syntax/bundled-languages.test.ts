...
const GRAMMARS: Readonly<Record<string, readonly [string, string]>> = {
  ...
  ruby: ['node_modules/tree-sitter-ruby/tree-sitter-ruby.wasm', 'node_modules/tree-sitter-ruby/queries/highlights.scm'],
  ocaml: ['node_modules/tree-sitter-ocaml/tree-sitter-ocaml.wasm', 'node_modules/tree-sitter-ocaml/queries/highlights.scm'],
  ocaml_interface: ['node_modules/tree-sitter-ocaml/tree-sitter-ocaml_interface.wasm', 'node_modules/tree-sitter-ocaml/queries/highlights.scm'],
