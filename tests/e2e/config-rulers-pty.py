#!/usr/bin/env python3
"""Prove editor.rulers paints a configured production editor column."""
...
with tempfile.TemporaryDirectory(prefix="xi-rulers-pty-") as temporary:
    root = Path(temporary)
...
print("Config rulers PTY passed: editor.rulers painted the configured column in launched Xi.")
