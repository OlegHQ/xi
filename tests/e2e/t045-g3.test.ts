...
import { formatProblemsLines, formatSearchLines, paintEditorFrame } from '../../packages/ui/src/index';
...
assert.equal(typeof formatProblemsLines, 'function', 'G3-LANGUAGE-01 Problems UI exists');
assert.equal(typeof formatSearchLines, 'function', 'G3-SEARCH-01 search UI exists');
