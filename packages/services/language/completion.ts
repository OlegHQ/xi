...
export interface CompletionItem { readonly id: string; readonly label: string; readonly kind?: number; readonly filterText?: string; readonly sortText?: string; readonly preselect?: boolean; readonly detail?: string; readonly documentation?: string; readonly textEdit?: CompletionTextEdit; readonly textEditReplace?: CompletionTextEdit; readonly textEditIsFallback?: boolean; readonly additionalTextEdits?: readonly CompletionTextEdit[]; readonly commitCharacters?: readonly string[]; readonly insertTextFormat?: 'plain' | 'snippet'; readonly resolveData?: unknown; }
